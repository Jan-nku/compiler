...
B29:
  ...
  store i32 %t0, i32* %t30, align 4
  store i32 %t2, i32* %t31, align 4
  br label %B33
B33:                               	; preds = %B29, %B34
  %t5 = load i32, i32* %t31, align 4
  %t6 = icmp sgt i32 %t5, 0
  br i1 %t6, label %B34, label %B36
B34:                               	; preds = %B33
  ...
  store i32 %t12, i32* %t30, align 4
  %t14 = load i32, i32* %t32, align 4
  store i32 %t14, i32* %t31, align 4
  br label %B33
B36:                               	; preds = %B33
  br label %B35
B35:                               	; preds = %B36
  %t15 = load i32, i32* %t30, align 4
  ret i32 %t15
}
define i32 @main() {
B39:
